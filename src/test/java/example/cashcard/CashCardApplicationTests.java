...
//START FROM PART 4 SPRING ACADEMY SPRING SECURITY
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
//@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD), don't use indiscriminately
class CashCardApplicationTests {
	@Autowired
	TestRestTemplate
	restTemplate;

//implementing GET/Read tests:
	@Test
...
//implementing POST/Create tests:
	@Test
	@DirtiesContext
...
//implementing PUT/UPDATE tests:
	...
	void shouldNotUpdateACashCardThatDoesNotExist(){
		...
		ResponseEntity<Void> response = restTemplate.withBasicAuth("sarah1", "abc123").exchange("/cashcards/99999", HttpMethod.PUT, request, Void.class);
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
	}
